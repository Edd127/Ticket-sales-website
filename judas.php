  ...
  <div class="artist">
    <div class="scris">
      ...
      <p>
        ...
        Letraset sheets containing Lorem Ipsum passages, nd more recently with
    ...
    <div class="slider">
      <div class="slides">
        ...
        <div class="slide first">
          <img src="https://static.iabilet.ro/img/auto_resized/db/event/00/bf/39/00000080897-b01f-720x405-wtm-4017e71c.jpg" alt="img1" />
        </div>
        <div class="slide">
          <img src="https://www.eventworld.co/blob/images/pg/judas-priest_3e465_opgh.jpg" alt="img2" />
        </div>
        <div class="slide">
          <img src="https://themusicnetwork.com/wp-content/uploads/report-heavy-metal-can-be-good-for-your-mental-health.jpg" alt="img3" />
        </div>
