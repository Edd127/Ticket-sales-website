  ...
  <div class="artist">
    <div class="scris">
      ...
      <p>
        ...
        passages, nd more recently with desktop publishing software like Aldus
    ...
    <div class="slider">
      <div class="slides">
        ...
        <div class="slide first">
          <img src="https://m.media-amazon.com/images/M/MV5BZWRiNzVkMjctZDViOS00Y2JkLWI3YWUtNWE2OGMxM2IzODcxL2ltYWdlL2ltYWdlXkEyXkFqcGdeQXVyNTI5NjIyMw@@._V1_.jpg" alt="img1" />
        </div>
        <div class="slide">
          <img src="https://i.ytimg.com/vi/ts9ugCelM6E/maxresdefault.jpg" alt="img2" />
        </div>
        <div class="slide">
          <img src="https://imotorhead.com/mh/wp-content/themes/imotorhead/images/homepage-header.jpg" alt="img3" />
        </div>
